...
exports.date_to_string = function (input) {
  var d = new Date(input);
  return d.toString();
}

exports.date_to_xmlschema = function (input) {
  var d = new Date(input);
  return d.toISOString();
}

exports.date_to_rfc822 = function (input) {
  var d = new Date(input);
...
// Alias for jekyll migration
exports.xml_escape = exports.escape;
